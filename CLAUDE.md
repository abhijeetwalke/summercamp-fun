...
- **Next step:** Abhi reviews Math + World + Basketball on `preview` in-browser → Gates. Math's two long poles still remain: parameterized variants (P2.4) and the full 800-question bank (Content Track). Optional Basketball levers: uniform section-review counts; more imagery.
